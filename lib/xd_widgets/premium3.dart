...
class premium3 extends StatelessWidget {
  premium3({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(4.4, 255.0),
            child:
                // Adobe XD layer: 'Forgot Password' (text)
                SizedBox(
              width: 367.0,
              child: Text(
                'Guadagna tempo quando vai al centro commerciale\nAvrai il tuo assistente personale per lo shopping sempre con te\nTi consiglia i vestiti da comprare in base al tuo armadio\nVai in negozio sapendo già cosa acquistare',
                style: TextStyle(
                  fontFamily: 'Roboto',
                  fontSize: 11,
                  color: const Color(0xff0f0a39),
          ...
          Transform.translate(
            offset: Offset(-23.0, 365.0),
            child:
                // Adobe XD layer: '5127314' (shape)
                Container(
              width: 421.0,
              height: 281.0,
              decoration: BoxDecoration(
