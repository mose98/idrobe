...
class premium4 extends StatelessWidget {
  premium4({
    Key? key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: Transform.rotate(
              ...
              child:
                ...
                width: 235.0,
                child: Text(
                  'Vendi facilmente i vestiti che non usi più',
                  style: TextStyle(
                    fontFamily: 'Roboto',
                    fontSize: 11,
                    color: const Color(0xff0f0a39),
